...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    neutron_flux=temperature*neutrons_emitted
    if temperature <800 and neutrons_emitted>500 and neutron_flux<500000:
        return True
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    neutron_flux=temperature*neutrons_produced_per_second
    if neutron_flux<(0.9*threshold):
        return 'LOW'
    elif neutron_flux>(0.9*threshold) and neutron_flux<=(1.1*threshold):
        return 'NORMAL'
    else:
        return 'DANGER'